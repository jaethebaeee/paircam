    ...
    <div className="min-h-screen py-8 sm:py-12 px-4 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16 pt-12 sm:pt-8">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-pink-600 via-purple-600 to-blue-600 bg-clip-text text-transparent mb-3 sm:mb-4 leading-tight px-2">
            Random Video Chat
          </h1>
          <p className="text-lg sm:text-xl text-gray-700 mb-4 sm:mb-6 px-4">
            Meet strangers instantly. No signup needed.
          </p>

          {/* Key Value Props - Compact */}
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mb-6 sm:mb-8 px-2">
            <span className="bg-white/90 px-3 py-1.5 rounded-full text-sm font-medium text-gray-700 shadow-sm">⚡ Instant</span>
            <span className="bg-white/90 px-3 py-1.5 rounded-full text-sm font-medium text-gray-700 shadow-sm">🔒 Anonymous</span>
            <span className="bg-white/90 px-3 py-1.5 rounded-full text-sm font-medium text-gray-700 shadow-sm">🌍 Worldwide</span>
          </div>

          {/* Hero Visual - Compact */}
          <div className="max-w-md sm:max-w-2xl mx-auto mb-8 sm:mb-12 px-2">
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl overflow-hidden aspect-video flex items-center justify-center relative">
        ...
        <div id="features" className="mb-8 sm:mb-12 px-2 scroll-mt-24">
          <h2 className="text-xl sm:text-2xl font-bold text-center text-gray-900 mb-4 sm:mb-6">How It Works</h2>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 max-w-3xl mx-auto">
            <div className="flex items-center gap-3 bg-white rounded-xl p-3 sm:p-4 shadow-md w-full sm:w-auto">
              <div className="bg-pink-500 w-8 h-8 rounded-lg flex items-center justify-center text-white font-bold">1</div>
              <span className="text-sm font-medium text-gray-700">Enter name</span>
            </div>
            <span className="hidden sm:block text-gray-300">→</span>
            <div className="flex items-center gap-3 bg-white rounded-xl p-3 sm:p-4 shadow-md w-full sm:w-auto">
              <div className="bg-purple-500 w-8 h-8 rounded-lg flex items-center justify-center text-white font-bold">2</div>
              <span className="text-sm font-medium text-gray-700">Get matched</span>
            </div>
            <span className="hidden sm:block text-gray-300">→</span>
            <div className="flex items-center gap-3 bg-white rounded-xl p-3 sm:p-4 shadow-md w-full sm:w-auto">
              <div className="bg-blue-500 w-8 h-8 rounded-lg flex items-center justify-center text-white font-bold">3</div>
              <span className="text-sm font-medium text-gray-700">Start chatting</span>
            </div>
          </div>
        </div>
        ...
        {/* Safety - Compact */}
        <div id="safety" className="mb-8 sm:mb-12 max-w-2xl mx-auto px-2 scroll-mt-24">
          <div className="bg-green-50 rounded-xl p-4 border border-green-200">
            <div className="flex items-center gap-3 mb-3">
              <span className="text-xl">🛡️</span>
              <h2 className="text-lg font-bold text-gray-900">Safe & Moderated</h2>
            </div>
            <div className="flex flex-wrap gap-2 text-xs sm:text-sm text-gray-600">
              <span className="bg-white px-2 py-1 rounded-full">✓ 24/7 moderation</span>
              <span className="bg-white px-2 py-1 rounded-full">✓ Report & block</span>
              <span className="bg-white px-2 py-1 rounded-full">✓ 18+ only</span>
              <span className="bg-white px-2 py-1 rounded-full">✓ Anonymous</span>
            </div>
          </div>
        </div>
