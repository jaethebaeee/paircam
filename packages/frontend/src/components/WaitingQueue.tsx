...
export default function WaitingQueue({ queuePosition, estimatedWaitTime, onCancel }: WaitingQueueProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 flex items-center justify-center px-3 sm:px-4 py-4">
      <div className="max-w-2xl w-full">
        {/* Main Card */}
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-5 sm:p-8 md:p-12 border border-gray-100">
          {/* Header */}
          <div className="text-center mb-6 sm:mb-8">
            <div className="inline-flex items-center justify-center w-14 h-14 sm:w-20 sm:h-20 bg-gradient-to-br from-pink-500 to-purple-600 rounded-full mb-4 sm:mb-6 animate-pulse">
              <SparklesIcon className="w-7 h-7 sm:w-10 sm:h-10 text-white" />
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
            {/* Queue Position */}
            <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center">
              <UserGroupIcon className="w-6 h-6 sm:w-8 sm:h-8 text-purple-600 mx-auto mb-1.5 sm:mb-2" />
              <div className="text-2xl sm:text-3xl font-bold text-purple-900 mb-0.5 sm:mb-1">
            ...
            <div className="bg-gradient-to-br from-blue-100 to-cyan-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center">
              <ClockIcon className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600 mx-auto mb-1.5 sm:mb-2" />
              <div className="text-2xl sm:text-3xl font-bold text-blue-900 mb-0.5 sm:mb-1">
          ...
          {/* Rotating Tips */}
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-orange-400 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="text-2xl sm:text-4xl mt-0.5 sm:mt-1 animate-bounce-subtle">
                {tips[currentTipIndex].icon}
              </div>
              <div>
                <div className="text-[10px] sm:text-sm font-semibold text-orange-900 mb-0.5 sm:mb-1 uppercase tracking-wide">
                  Quick Tip
                </div>
          ...
          {/* Safety Badge */}
          <div className="flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6">
            <ShieldCheckIcon className="w-4 h-4 sm:w-5 sm:h-5 text-green-600" />
            <span className="text-center">Your safety is our priority • All chats are monitored</span>
          </div>

          {/* Cancel Button */}
          <button
            onClick={onCancel}
            className="w-full py-3 sm:py-4 px-4 sm:px-6 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold text-sm sm:text-base rounded-xl transition-all duration-300 hover:shadow-lg active:scale-95"
          >
            Cancel and Go Back
          </button>
