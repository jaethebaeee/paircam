      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-8 md:p-12 border border-gray-100">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-pink-500 to-purple-600 rounded-full mb-4 sm:mb-6 animate-pulse">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
            ...
            <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center">
              <UserGroupIcon className="w-6 h-6 sm:w-8 sm:h-8 text-purple-600 mx-auto mb-1 sm:mb-2" />
            ...
            <div className="bg-gradient-to-br from-blue-100 to-cyan-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center">
              <ClockIcon className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600 mx-auto mb-1 sm:mb-2" />
          ...
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-orange-400 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="text-3xl sm:text-4xl mt-0.5 sm:mt-1 animate-bounce-subtle">
                {tips[currentTipIndex].icon}
              </div>
              <div>
                <div className="text-xs sm:text-sm font-semibold text-orange-900 mb-1 uppercase tracking-wide">
                  Quick Tip
                </div>
          ...
          <button
            onClick={onCancel}
            className="w-full py-3 sm:py-4 px-4 sm:px-6 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-xl transition-all duration-300 hover:shadow-lg active:scale-95 text-sm sm:text-base"
          >
            Cancel and Go Back
          </button>
