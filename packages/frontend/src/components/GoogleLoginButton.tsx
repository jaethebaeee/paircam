...
export default function GoogleLoginButton({ variant = 'full', onSuccess }: GoogleLoginButtonProps) {
  ...
  if (variant === 'compact') {
    return (
      <button
        ...
        disabled={isLoading}
        className="p-2.5 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
