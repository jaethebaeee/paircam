...
export default function VideoControls({
  ...
  return (
    <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 z-50 w-full px-4 sm:px-0 sm:w-auto">
      {/* Control Bar with Labels */}
      <div className="bg-gray-900/95 backdrop-blur-xl rounded-2xl sm:rounded-[32px] shadow-2xl px-3 sm:px-6 py-3 sm:py-4 border border-white/10 max-w-full">
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap">
          ...
          {!isTextMode && (
            <div className="relative group">
              <button
                ...
                className={`relative p-3 sm:p-4 rounded-full transition-all duration-300 transform hover:scale-110 active:scale-95 min-w-[44px] min-h-[44px] sm:min-w-[48px] sm:min-h-[48px] flex items-center justify-center ${
                  isAudioEnabled
                    ? 'bg-gray-700 hover:bg-gray-600'
          ...
          <div className="relative group">
            <button
              ...
              className="relative p-4 sm:p-5 rounded-full bg-red-500 hover:bg-red-600 shadow-lg shadow-red-500/50 transition-all duration-300 transform hover:scale-110 active:scale-95 hover:shadow-red-500/70"
          ...
          <div className="relative group">
            <button
              onClick={onNext}
              disabled={isSkipping}
              className={`relative p-3 sm:p-4 rounded-full shadow-lg transition-all duration-300 transform min-w-[44px] min-h-[44px] sm:min-w-[48px] sm:min-h-[48px] flex items-center justify-center ${
                isSkipping
      ...
      {/* Secondary Info Bar - Hidden on very small screens */}
