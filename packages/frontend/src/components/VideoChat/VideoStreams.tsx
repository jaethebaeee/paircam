          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center animate-fadeIn">
            ...
            <div className="relative mb-8">
              ...
              <div className="absolute inset-0 -m-8">
                <div className="w-32 h-32 rounded-full bg-gradient-to-r from-slate-500/30 to-indigo-500/30 animate-ping-slow"></div>
              </div>
              {/* Middle ripple */}
              <div className="absolute inset-0 -m-4">
                <div className="w-24 h-24 rounded-full bg-gradient-to-r from-slate-500/40 to-indigo-500/40 animate-ping-slower"></div>
              </div>
              {/* Inner circle with icon */}
              <div className="relative w-16 h-16 rounded-full bg-gradient-to-r from-slate-600 to-indigo-600 flex items-center justify-center shadow-2xl shadow-slate-500/50 animate-pulse-gentle">
            ...
            {showMatchedAnimation && (
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
                <div className="animate-scale-fade-out">
                  <div className="bg-gradient-to-r from-slate-700 to-indigo-600 rounded-3xl px-8 py-4 shadow-2xl">
                    <div className="flex items-center gap-3">
                      <SparklesIcon className="w-8 h-8 text-white animate-spin-slow" />
                      <span className="text-white text-2xl font-bold">Connected!</span>
