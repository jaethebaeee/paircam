          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center animate-fadeIn">
            ...
            <div className="relative mb-8">
              ...
              <div className="absolute inset-0 -m-8">
                <div className="w-32 h-32 rounded-full bg-gradient-to-r from-primary-500/30 to-secondary-500/30 animate-ping-slow"></div>
              </div>
              {/* Middle ripple */}
              <div className="absolute inset-0 -m-4">
                <div className="w-24 h-24 rounded-full bg-gradient-to-r from-primary-500/40 to-secondary-500/40 animate-ping-slower"></div>
              </div>
              {/* Inner circle with icon */}
              <div className="relative w-16 h-16 rounded-full bg-gradient-to-r from-primary-500 to-secondary-600 flex items-center justify-center shadow-2xl shadow-primary-500/50 animate-pulse-gentle">
            ...
            <div className="text-center space-y-2 animate-fadeIn" style={{ animationDelay: '200ms' }}>
              ...
              <div className="flex gap-1 justify-center mt-4">
                ...
                <div className="w-2 h-2 rounded-full bg-secondary-500 animate-bounce" style={{ animationDelay: '150ms' }}></div>
            ...
            {showMatchedAnimation && (
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
                <div className="animate-scale-fade-out">
                  <div className="bg-gradient-to-r from-primary-500 to-secondary-600 rounded-3xl px-8 py-4 shadow-2xl">
