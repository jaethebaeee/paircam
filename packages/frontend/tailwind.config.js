...
export default {
  ...
  theme: {
    extend: {
      ...
      // Brand Colors
      colors: {
        // Primary - Pink/Magenta (main brand color)
        brand: {
          50: '#fdf2f8',
          100: '#fce7f3',
          200: '#fbcfe8',
        ...
        // Secondary - Purple/Violet (gradient companion)
        violet: {
          50: '#faf5ff',
          100: '#f3e8ff',
          200: '#e9d5ff',
      ...
      keyframes: {
        ...
        glowPulse: {
          ...
          '50%': { boxShadow: '0 0 35px rgba(236, 72, 153, 0.5), 0 0 45px rgba(168, 85, 247, 0.3)' },
        },
        float: {
          '0%, 100%': { transform: 'translateY(0)' },
